    ...
    return (
      <Router>
        <div className="App">
          ...
          <Route path="/catalog" exact render={({ match }) => <Catalog match={match} movies={this.state.movies} budget={this.state.budget} rented={this.rented} returnMovie={this.returnMovie} search={this.searchMovie} resetSearch={this.resetSearch} />} />
